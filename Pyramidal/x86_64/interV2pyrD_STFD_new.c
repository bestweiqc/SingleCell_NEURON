...
#define DA2 DA2_interV2pyrD_STFD
#define DA1 DA1_interV2pyrD_STFD
#define GAP1 GAP1_interV2pyrD_STFD
#define NE2 NE2_interV2pyrD_STFD
#define NEn NEn_interV2pyrD_STFD
...
#define Betan2 Betan2_interV2pyrD_STFD
 double Betan2 = 0.0001;
#define Betan1 Betan1_interV2pyrD_STFD
 double Betan1 = 0.001;
#define Beta2 Beta2_interV2pyrD_STFD
 double Beta2 = 0.0001;
#define Beta1 Beta1_interV2pyrD_STFD
 double Beta1 = 0.001;
#define DA_S DA_S_interV2pyrD_STFD
 double DA_S = 1.6;
#define DA_t3 DA_t3_interV2pyrD_STFD
 double DA_t3 = 1.25;
#define DA_t2 DA_t2_interV2pyrD_STFD
 double DA_t2 = 1.5;
#define DA_t1 DA_t1_interV2pyrD_STFD
 double DA_t1 = 0.7;
#define DAstop2 DAstop2_interV2pyrD_STFD
 double DAstop2 = 36000;
#define DAstart2 DAstart2_interV2pyrD_STFD
 double DAstart2 = 35900;
#define DAstop1 DAstop1_interV2pyrD_STFD
 double DAstop1 = 40000;
#define DAstart1 DAstart1_interV2pyrD_STFD
...
#define NE_S NE_S_interV2pyrD_STFD
 double NE_S = 1;
#define NE_t3 NE_t3_interV2pyrD_STFD
 double NE_t3 = 1;
#define NE_t2 NE_t2_interV2pyrD_STFD
 double NE_t2 = 1;
#define NE_t1 NE_t1_interV2pyrD_STFD
 double NE_t1 = 1;
#define NEstop2 NEstop2_interV2pyrD_STFD
 double NEstop2 = 36000;
#define NEstart2 NEstart2_interV2pyrD_STFD
 double NEstart2 = 35900;
#define NEstop1 NEstop1_interV2pyrD_STFD
 double NEstop1 = 40000;
#define NEstart1 NEstart1_interV2pyrD_STFD
...
#define k k_interV2pyrD_STFD
 ...
 "Beta1_interV2pyrD_STFD", "/ms",
 "Beta2_interV2pyrD_STFD", "/ms",
 "Betan1_interV2pyrD_STFD", "/ms",
 "Betan2_interV2pyrD_STFD", "/ms",
 "srcid", "1",
 "destid", "1",
 "Cdur_gaba", "ms",
 "AlphaTmax_gaba", "/ms",
 ...
 "DAstart1_interV2pyrD_STFD", &DAstart1_interV2pyrD_STFD,
 "DAstop1_interV2pyrD_STFD", &DAstop1_interV2pyrD_STFD,
 "DAstart2_interV2pyrD_STFD", &DAstart2_interV2pyrD_STFD,
 "DAstop2_interV2pyrD_STFD", &DAstop2_interV2pyrD_STFD,
 "DA_t1_interV2pyrD_STFD", &DA_t1_interV2pyrD_STFD,
 "DA_t2_interV2pyrD_STFD", &DA_t2_interV2pyrD_STFD,
 "DA_t3_interV2pyrD_STFD", &DA_t3_interV2pyrD_STFD,
 "DA_S_interV2pyrD_STFD", &DA_S_interV2pyrD_STFD,
 "Beta1_interV2pyrD_STFD", &Beta1_interV2pyrD_STFD,
 "Beta2_interV2pyrD_STFD", &Beta2_interV2pyrD_STFD,
 "NEstart1_interV2pyrD_STFD", &NEstart1_interV2pyrD_STFD,
 "NEstop1_interV2pyrD_STFD", &NEstop1_interV2pyrD_STFD,
 "NEstart2_interV2pyrD_STFD", &NEstart2_interV2pyrD_STFD,
 "NEstop2_interV2pyrD_STFD", &NEstop2_interV2pyrD_STFD,
 "NE_t1_interV2pyrD_STFD", &NE_t1_interV2pyrD_STFD,
 "NE_t2_interV2pyrD_STFD", &NE_t2_interV2pyrD_STFD,
 "NE_t3_interV2pyrD_STFD", &NE_t3_interV2pyrD_STFD,
 "NE_S_interV2pyrD_STFD", &NE_S_interV2pyrD_STFD,
 "Betan1_interV2pyrD_STFD", &Betan1_interV2pyrD_STFD,
 "Betan2_interV2pyrD_STFD", &Betan2_interV2pyrD_STFD,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _interV2pyrD_STFD_new_reg() {
	int _vectorized = 0;
  _initlists();
 	ion_reg("ca", -10000.);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 interV2pyrD_STFD /Users/kevinwinni/Desktop/SingleCell_NEURON/Pyramidal/x86_64/interV2pyrD_STFD_new.mod\n");
 ...
 v=_v;
{
  ...
  ica = _ion_ica;
 { error =  release();
 if(error){fprintf(stderr,"at line 182 in file interV2pyrD_STFD_new.mod:\n	\n"); nrn_complain(_p); abort_run(error);}
 }}}
