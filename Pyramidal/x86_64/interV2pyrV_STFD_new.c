...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 interV2pyrV_STFD /Users/kevinwinni/Desktop/SingleCell_NEURON/Pyramidal/x86_64/interV2pyrV_STFD_new.mod\n");
 ...
 v=_v;
{
  ...
  ica = _ion_ica;
 { error =  release();
 if(error){fprintf(stderr,"at line 169 in file interV2pyrV_STFD_new.mod:\n	\n"); nrn_complain(_p); abort_run(error);}
 }}}
