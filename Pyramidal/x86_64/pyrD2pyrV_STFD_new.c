...
#define DA2 DA2_pyrD2pyrV_STFD
#define DA1 DA1_pyrD2pyrV_STFD
...
#define Beta2 Beta2_pyrD2pyrV_STFD
 double Beta2 = 0.0001;
#define Beta1 Beta1_pyrD2pyrV_STFD
 double Beta1 = 0.001;
#define DA_S DA_S_pyrD2pyrV_STFD
 double DA_S = 1.3;
#define DA_t3 DA_t3_pyrD2pyrV_STFD
 double DA_t3 = 1;
#define DA_t2 DA_t2_pyrD2pyrV_STFD
 double DA_t2 = 1;
#define DA_t1 DA_t1_pyrD2pyrV_STFD
 double DA_t1 = 1;
#define DAstop2 DAstop2_pyrD2pyrV_STFD
 double DAstop2 = 36000;
#define DAstart2 DAstart2_pyrD2pyrV_STFD
 double DAstart2 = 35900;
#define DAstop1 DAstop1_pyrD2pyrV_STFD
 double DAstop1 = 40000;
#define DAstart1 DAstart1_pyrD2pyrV_STFD
...
#define GAPstart1 GAPstart1_pyrD2pyrV_STFD
 ...
 "Beta1_pyrD2pyrV_STFD", "/ms",
 "Beta2_pyrD2pyrV_STFD", "/ms",
 "srcid", "1",
 "destid", "1",
 "Cdur_nmda", "ms",
 "AlphaTmax_nmda", "/ms",
 ...
 "DAstart1_pyrD2pyrV_STFD", &DAstart1_pyrD2pyrV_STFD,
 "DAstop1_pyrD2pyrV_STFD", &DAstop1_pyrD2pyrV_STFD,
 "DAstart2_pyrD2pyrV_STFD", &DAstart2_pyrD2pyrV_STFD,
 "DAstop2_pyrD2pyrV_STFD", &DAstop2_pyrD2pyrV_STFD,
 "DA_t1_pyrD2pyrV_STFD", &DA_t1_pyrD2pyrV_STFD,
 "DA_t2_pyrD2pyrV_STFD", &DA_t2_pyrD2pyrV_STFD,
 "DA_t3_pyrD2pyrV_STFD", &DA_t3_pyrD2pyrV_STFD,
 "DA_S_pyrD2pyrV_STFD", &DA_S_pyrD2pyrV_STFD,
 "Beta1_pyrD2pyrV_STFD", &Beta1_pyrD2pyrV_STFD,
 "Beta2_pyrD2pyrV_STFD", &Beta2_pyrD2pyrV_STFD,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 pyrD2pyrV_STFD /Users/kevinwinni/Desktop/SingleCell_NEURON/Pyramidal/x86_64/pyrD2pyrV_STFD_new.mod\n");
 ...
 v=_v;
{
  eca = _ion_eca;
 { error =  release();
 if(error){fprintf(stderr,"at line 170 in file pyrD2pyrV_STFD_new.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
