...
NEURON {
	...
	RANGE fmax, fmin, Wmax, Wmin, maxChange, normW, scaleW, srcid, destid, tempW,limitW
...
PARAMETER {
	...
	:AMPA Weight
	initW = 2.0 : 1.0 :  0.9 : 2 : 0.7 : 2 : 3 : 4 : 2: 4 : 1 : 0.3: 2 :1.5
	fmax = 3
	fmin = .8
...
DERIVATIVE release {
    : W' = eta(capoolcon)*(lambda1*omega(capoolcon, threshold1, threshold2)-lambda2*GAP1(GAPstart1, GAPstop1)*W)
